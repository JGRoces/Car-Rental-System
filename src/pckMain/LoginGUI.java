 ...
 *
 * Layout:  [ LEFT PANEL — Image (60%) ] [ RIGHT PANEL — Login Form (40%) ]
 * Size:    1200 x 800
...
public class LoginGUI extends JFrame {
    ...
    private JPanel buildLeftPanel() {
        ...
        // Tagline
        JLabel tagline = new JLabel("<html>Your trusted platform for<br>seamless car rental management.</html>");
    ...
    private JPanel buildRightPanel() {
        ...
        // Show password — default Swing checkbox, no custom painting
